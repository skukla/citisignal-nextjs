...
function Button({
  ...
  const baseClasses = twMerge(
    ...
    variant !== 'link' && 'rounded-lg font-medium focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2'
  );
  ...
  const classes = twMerge(
    ...
    variant === 'link' && 'text-purple-600 hover:text-purple-700 focus:outline-none focus:ring-0 p-0',
    // Sizes
    variant !== 'link' && (
