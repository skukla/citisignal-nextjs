    ...
    filteredElements.forEach((el) => {
      ...
      if (activeSources.has(source)) {
        ...
        if (sourceInfo) {
          ...
          const isCheckboxOrRadio = element.tagName === 'INPUT' && 
          ...
          const needsInsetShadow = 
            ...
            (element.querySelector('input[type="text"]') || element.querySelector('input[type="search"]')) ||
          ...
          if (needsInsetShadow) {
            ...
            const nestedInput = element.querySelector('input[type="text"], input[type="search"], input:not([type])');
        ...
        try {
          ...
          element.style.backgroundColor = element.dataset.originalBackground || original.backgroundColor || '';
          ...
          if (nestedInput && nestedInput instanceof HTMLElement && nestedInput.dataset.originalBoxShadow !== undefined) {
    ...
    const observer = new MutationObserver((mutations) => {
      ...
      mutations.forEach(mutation => {
        ...
        if (mutation.type === 'attributes' && 
            mutation.attributeName === 'data-inspector-source') {
          shouldReapply = true;
        }
        ...
        if (mutation.type === 'childList' && mutation.addedNodes.length > 0) {
          mutation.addedNodes.forEach(node => {
            if (node.nodeType === Node.ELEMENT_NODE) {
              ...
              if (element.hasAttribute('data-inspector-source') || 
