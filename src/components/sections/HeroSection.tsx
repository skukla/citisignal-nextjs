...
export default function HeroSection() {
  return (
    <section className="text-white" style={{ background: 'linear-gradient(135deg, #8821f4 0%, #6a1b9a 50%, #4a148c 100%)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Content */}
          <div>
            <div className="inline-flex items-center px-4 py-2 bg-purple-800 bg-opacity-80 rounded-full text-sm font-medium mb-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-purple-100 text-sm ml-5">
              ...
              <div className="bg-gradient-to-br from-white to-gray-100 rounded-2xl p-8 shadow-2xl">
                <div className="space-y-6">
                  ...
                  <div className="text-center text-gray-800">
                    <div className="text-2xl font-bold text-purple-600">$10/month</div>
