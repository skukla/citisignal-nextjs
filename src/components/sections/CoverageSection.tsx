        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="card p-6">
            <div className="flex items-center mb-4">
              <div className={clsx(
                'w-10 h-10 bg-primary-100 rounded-lg',
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-primary-600 font-semibold">99%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-primary-600 h-2 rounded-full" style={{ width: '99%' }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-1">
          ...
          <div className="card p-6">
            <div className="flex items-center mb-4">
              <div className={clsx(
                ...
                <GlobeAmericasIcon className="w-6 h-6 text-primary-600" />
              </div>
